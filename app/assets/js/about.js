...
function prepareInternalNav() {
  ...
  for (let i = 0; i < links.length; i += i + 1) {
    ...
    if (!document.getElementById(sectionId)) continue; // eslint-disable-line no-continue
    ...
    links[i].onclick = function clickMouse() {
...
addLoadEvent(prepareInternalNav); // eslint-disable-line no-continue
